# Names shamelessly imported from here: https://github.com/moby/moby/blob/master/pkg/namesgenerator/names-generator.go
...
last = [
    ...
    # Mathematics Professor at a University.
    ...
    # a leading architect for the US security space programs.
    ...
    # Buckaroo Banzai and his mentor Dr. Hikita perfectd the "oscillation overthruster",
    ...
    # Sue Black - British computer scientist and campaigner. She has been instrumental
    # in saving Bletchley Park, the site of World War II codebreaking
    ...
    # in mathematics; she earned it in 1949 from Yale University.
    ...
    # Linda Brown Buck - American biologist and Nobel laureate best known for her genetic
    # and molecular analyses of the mechanisms of smell.
    ...
    # and was the first to analyse them
    ...
    # is now known as chaos theory. Also known for Cartwright's theorem which finds applications
    ...
    # Sergey Alexeyevich Chaplygin (Russian: Серге́й Алексе́евич Чаплы́гин; April 5, 1869 – October 8, 1942)
    # was a Russian and Soviet physicist, mathematician, and mechanical engineer.
    # He is known for mathematical formulas such as Chaplygin's equation and for a
    # hypothetical substance in cosmology called Chaplygin gas, named after him.
    # https://en.wikipedia.org/wiki/Sergey_Chaplygin
    "chaplygin",

    # Émilie du Châtelet - French natural philosopher, mathematician, physicist, 
    # and author during the early 1730s, known for her translation of and commentary on 
    # Isaac Newton's book Principia containing basic laws of physics. 
    ...
    # Pafnuty Chebyshev - Russian mathematician. He is known fo his works on probability, statistics,
    # mechanics, analytical geometry and number theory https://en.wikipedia.org/wiki/Pafnuty_Chebyshev
    "chebyshev",
    ...
    # David Lee Chaum - American computer scientist and cryptographer. Known for his seminal contributions
    ...
    # remained top secret for decades. Also an accomplished numismatist https://en.wikipedia.org/wiki/Joan_Clarke
    "clarke",
    ...
    # Nobel Prize in science, and the first woman to be awarded the Nobel Prize in Physiology or Medicine.
    # Cori was born in Prague
    # https://en.wikipedia.org/wiki/Gerty_Cori
    "cori",

    # Seymour Roger Cray was an American electrical engineer and supercomputer architect who designed a
    # series of computers that were the fastest in the world for decades
    ...
    # Contributor to Scientific American's "Computer Recreations" from 1984 to 1991. Author of Core War
    # (program), The Planiverse, The Armchair Universe, The Magic Machine, The New Turing Omnibus, and more
    # https://en.wikipedia.org/wiki/Alexander_Dewdney
    "dewdney",

    # Satish Dhawan - Indian mathematician and aerospace engineer, known for leading the successful
    # and indigenous development of the Indian space programme
    ...
    # Paul Adrien Maurice Dirac - English theoretical physicist who made fundamental contributions
    # to the early development of both quantum mechanics and quantum electrodynamics
    ...
    # Donna Dubinsky - played an integral role in the development of personal digital assistants
    # (PDAs) serving as CEO of Palm, Inc. and co-founding Handspring
    ...
    # rocket stage and one of the first African-Americans in her field
    ...
    # computer programmer, internet pirate in hiding, and the creator of the site Sci-Hub. Nature has listed
    # her in 2016 in the top ten people that mattered in science, and Ars Technica has compared her to Aaron Swartz.
    # tps://en.wikipedia.org/wiki/Alexandra_Elbakyan
    "elbakyan",
    ...
    # for the first time, the idea of public-key cryptography
    ...
    # Michael Faraday - British scientist who contributed to the study of electromagnetism and electro-chemistry
    ...
    # Yuri Alekseyevich Gagarin - Soviet pilot and cosmonaut, best known as the first human to journey
    # into outer space
    ...
    # Évariste Galois - French mathematician whose work laid the foundations of Galois theory and
    # group theory, two major branches of abstract algebra, and the subfield of Galois connections,
    # all while still in his late teens
    ...
    # trained in western medicine, to graduate in South Asia
    ...
    # Johann Carl Friedrich Gauss - German mathematician who made significant contributions to many
    # fields, including number theory, algebra, statistics, analysis, differential geometry, geodesy,
    # geophysics, mechanics, electrostatics, magnetic fields, astronomy, matrix theory, and optics
    # https://en.wikipedia.org/wiki/Carl_Friedrich_Gauss
    "gauss",

    # Marie-Sophie Germain - French mathematician, physicist and philosopher. Known for her work
    # on elasticity theory, number theory and philosophy
    ...
    # Stephen Jay Gould was was an American paleontologist, evolutionary biologist, and historian of
    # science. He is most famous for the theory of punctuated equilibrium
    # https://en.wikipedia.org/wiki/Stephen_Jay_Gould
    "gould",

    # Carolyn Widney Greider - American molecular biologist and joint winner of the 2009 Nobel Prize
    # for Physiology or Medicine for the discovery of telomerase
    # https://en.wikipedia.org/wiki/Carol_W._Greider
    "greider",

    # Alexander Grothendieck - German-born French mathematician who became a leading figure in the
    # creation of modern algebraic geometry
    ...
    # Margaret Hamilton - Director of the Software Engineering Division of the MIT Instrumentation
    # Laboratory, which developed on-board flight software for the Apollo space program
    # https://en.wikipedia.org/wiki/Margaret_Hamilton_(scientist)
    "hamilton",

    # Caroline Harriet Haslett - English electrical engineer, electricity industry administrator and
    # champion of women's rights. Co-author of British Standard 1363 that specifies AC power plugs and
    # sockets used across the United Kingdom (which is widely considered as one of the safest designs)
    ...
    # Heinrich Rudolf Hertz - German physicist who first conclusively proved the existence of the
    # electromagnetic waves
    # https://en.wikipedia.org/wiki/Heinrich_Hertz
    "hertz",

    # Jaroslav Heyrovský was the inventor of the polarographic method, father of the electroanalytical
    # method, and recipient of the Nobel Prize in 1959. His main field of work was polarography
    ...
    # Douglas R. Hofstadter is an American professor of cognitive science and author of the Pulitzer Prize
    # and American Book Award-winning work Goedel, Escher, Bach: An Eternal Golden Braid in 1979. A
    # mind-bending work which coined Hofstadter's Law: "It always takes longer than you expect, even when
    # you take into account Hofstadter's Law." https://en.wikipedia.org/wiki/Douglas_Hofstadter
    "hofstadter",

    # Erna Schneider Hoover revolutionized modern communication by inventing a computerized telephone
    # switching method
    # https://en.wikipedia.org/wiki/Erna_Schneider_Hoover
    "hoover",

    # Grace Hopper developed the first compiler for a computer programming language and  is credited with
    # popularizing the term "debugging" for fixing computer glitches
    # https://en.wikipedia.org/wiki/Grace_Hopper
    "hopper",

    # Frances Hugle, she was an American scientist, engineer, and inventor who contributed to the
    # understanding of semiconductors, integrated circuitry, and the unique electrical principles of
    ...
    # NASA's engineering department
    # https://en.wikipedia.org/wiki/Mary_Jackson_(engineer)
    "jackson",

    # Yeong-Sil Jang was a Korean scientist and astronomer during the Joseon Dynasty; he invented the
    # first metal printing press and water gauge
    ...
    # Mary Lou Jepsen, was the founder and chief technology officer of One Laptop Per Child (OLPC), and
    ...
    # Irène Joliot-Curie - French scientist who was awarded the Nobel Prize for Chemistry in 1935. Daughter
    # of Marie and Pierre Curie
    # https://en.wikipedia.org/wiki/Ir%C3%A8ne_Joliot-Curie
    "joliot",

    # Karen Spärck Jones came up with the concept of inverse document frequency, which is used in most search
    # engines today
    # https://en.wikipedia.org/wiki/Karen_Sp%C3%A4rck_Jones
    "jones",

    # A. P. J. Abdul Kalam - is an Indian scientist aka Missile Man of India for his work on the development
    # of ballistic missile and launch vehicle technology
    # https://en.wikipedia.org/wiki/A._P._J._Abdul_Kalam
    "kalam",

    # Sergey Petrovich Kapitsa (Russian: Серге́й Петро́вич Капи́ца; 14 February 1928 – 14 August 2012) was a
    # Russian physicist and demographer. He was best known as host of the popular and long-running Russian
    # scientific TV show, Evident, but Incredible. His father was the Nobel laureate Soviet-era physicist
    ...
    # Susan Kare, created the icons and many of the interface elements for the original Apple Macintosh in the
    # 1980s, and was an original employee of NeXT, working as the Creative Director
    # https://en.wikipedia.org/wiki/Susan_Kare
    "kare",

    # Mstislav Keldysh - a Soviet scientist in the field of mathematics and mechanics, academician of the USSR
    # Academy of Sciences (1946), President of the USSR Academy of Sciences (1961–1975), three times Hero of
    # Socialist Labor (1956, 1961, 1971), fellow of the Royal Society of Edinburgh (1968)
    ...
    # Omar Khayyam - Persian mathematician, astronomer and poet. Known for his work on the classification
    # and solution of cubic equations, for his contribution to the understanding of Euclid's fifth postulate
    # and for computing the length of a year very accurately
    ...
    # Donald Knuth - American computer scientist, author of "The Art of Computer Programming" and creator of
    ...
    # Hedy Lamarr - Actress and inventor. The principles of her work are now incorporated into modern Wi-Fi,
    # CDMA and Bluetooth technology
    # https://en.wikipedia.org/wiki/Hedy_Lamarr
    "lamarr",

    # Leslie B. Lamport - American computer scientist. Lamport is best known for his seminal work in
    # distributed systems and was the winner of the 2013 Turing Award
    ...
    # Henrietta Swan Leavitt - she was an American astronomer who discovered the relation between the
    # luminosity and the period of Cepheid variable stars
    ...
    # Inge Lehmann - Danish seismologist and geophysicist. Known for discovering in 1936 that the Earth
    # has a solid inner core inside a molten outer core
    # https://en.wikipedia.org/wiki/Inge_Lehmann
    "lehmann",

    # Daniel Lewin - Mathematician, Akamai co-founder, soldier, 9/11 victim -- Developed optimization
    # techniques for routing traffic on the internet. Died attempting to stop the 9-11 hijackers
    ...
    # Barbara Liskov - co-developed the Liskov substitution principle. Liskov was also the winner of the
    # Turing Prize in 2008.
    ...
    # Lynn Margulis (b. Lynn Petra Alexander) - an American evolutionary theorist and biologist, science
    # author, educator, and popularizer, and was the primary modern proponent for the significance of
    # symbiosis in evolution.
    # https://en.wikipedia.org/wiki/Lynn_Margulis
    "margulis",

    # Yukihiro Matsumoto - Japanese computer scientist and software programmer best known as the chief
    ...
    # Maria Mayer - American theoretical physicist and Nobel laureate in Physics for proposing the
    # nuclear shell model of the atomic nucleus
    ...
    # Barbara McClintock - a distinguished American cytogeneticist, 1983 Nobel Laureate in Physiology or
    # Medicine for discovering transposons
    ...
    # Dmitri Mendeleev - a chemist and inventor. He formulated the Periodic Law, created a farsighted
    # version of the periodic table of elements, and used it to correct the properties of some already
    # discovered elements and also to predict the properties of eight elements yet to be discovered
    ...
    # Ralph C. Merkle - American computer scientist, known for devising Merkle's puzzles - one of the very
    # first schemes for public-key cryptography. Also, inventor of Merkle trees and co-inventor of the
    # Merkle-Damgård construction for building collision-resistant cryptographic hash functions and the
    ...
    # Samuel Morse - contributed to the invention of a single-wire telegraph system based on European
    # telegraphs and was a co-developer of the Morse code
    ...
    # Best known for his discovery of logarithms
    # https://en.wikipedia.org/wiki/John_Napier
    "napier",

    # John Forbes Nash, Jr. - American mathematician who made fundamental contributions to game theory,
    ...
    # Panini - Ancient Indian linguist and grammarian from 4th century CE who worked on the world's
    # first formal system
    ...
    # Cecilia Payne-Gaposchkin was an astronomer and astrophysicist who, in 1925, proposed in her
    # Ph.D. thesis an explanation for the composition of stars in terms of the relative abundances
    # of hydrogen and helium
    # https://en.wikipedia.org/wiki/Cecilia_Payne-Gaposchkin
    "payne",

    # Radia Perlman is a software designer and network engineer and most famous for her invention
    ...
    # advances the causes of truth and freedom of information by reporting disclosures by whistleblowers
    # such as Edward Snowden
    # https://en.wikipedia.org/wiki/Laura_Poitras
    "poitras",

    # Tat’yana Avenirovna Proskuriakova (Russian: Татья́на Авени́ровна Проскуряко́ва)
    # (January 23 [O.S. January 10] 1909 – August 30, 1985) was a Russian-American Mayanist
    # scholar and archaeologist who contributed significantly to the deciphering of Maya
    # hieroglyphs, the writing system of the pre-Columbian Maya civilization of Mesoamerica
    # https://en.wikipedia.org/wiki/Tatiana_Proskouriakoff
    "proskuriakova",

    # Claudius Ptolemy - a Greco-Egyptian writer of Alexandria, known as a mathematician, astronomer,
    ...
    # Srinivasa Ramanujan - Indian mathematician and autodidact who made extraordinary contributions
    # to mathematical analysis, number theory, infinite series, and continued fractions.
    # https://en.wikipedia.org/wiki/Srinivasa_Ramanujan
    "ramanujan",

    # Sally Kristen Ride was an American physicist and astronaut. She was the first American woman
    # in space, and the youngest American astronaut
    ...
    # Wilhelm Conrad Röntgen - German physicist who was awarded the first Nobel Prize in Physics
    # in 1901 for the discovery of X-rays (Röntgen rays)
    ...
    # Adi Shamir - Israeli cryptographer whose numerous inventions and contributions to cryptography
    # include the Ferge Fiat Shamir identification scheme, the Rivest Shamir Adleman (RSA)
    # public-key cryptosystem, the Shamir's secret sharing scheme, the breaking of the Merkle-Hellman
    # cryptosystem, the TWINKLE and TWIRL factoring devices and the discovery of differential
    # cryptanalysis (with Eli Biham)
    ...
    # Lina Solomonovna Stern (or Shtern; Russian: Лина Соломоновна Штерн; 26 August 1878 – 7 March 1968)
    # was a Soviet biochemist, physiologist and humanist whose medical discoveries saved thousands of 
    # lives at the fronts of World War II. She is best known for her pioneering work on blood–brain barrier,
    ...
    # the concept of copyleft to protect the ideals of this movement, and enshrined this concept
    # in the widely-used GPL (General Public License) for software
    ...
    # Ivan Edward Sutherland - American computer scientist and Internet pioneer, widely regarded as
    ...
    # Aaron Swartz was influential in creating RSS, Markdown, Creative Commons, Reddit, and much of the
    # internet as we know it today. He was devoted to freedom of information on the web
    ...
    # Valentina Tereshkova is a Russian engineer, cosmonaut and politician. She was the first woman
    # to fly to space in 1963. In 2013, at the age of 76, she offered to go on a one-way mission to Mars
    ...
    # dihydroartemisinin, used to treat malaria, which has saved millions of lives. Joint winner of 
    ...
    # Dorothy Vaughan was a NASA mathematician and computer programmer on the SCOUT launch vehicle program
    # that put America's first satellites into space 
    # https://en.wikipedia.org/wiki/Dorothy_Vaughan
    "vaughan",

    # Sir Mokshagundam Visvesvaraya - is a notable Indian engineer.  He is a recipient of the Indian
    # Republic's highest honour, the Bharat Ratna, in 1955. On his birthday, 15 September is celebrated 
    # as Engineer's Day in India in his memory 
    # https://en.wikipedia.org/wiki/Visvesvaraya
    "visvesvaraya",

    # Christiane Nüsslein-Volhard - German biologist, won Nobel Prize in Physiology or Medicine in 
    # 1995 for research on the genetic control of embryonic development
    ...
    # Sylvia B. Wilbur - British computer scientist who helped develop the ARPANET,
    # was one of the first to exchange email in the UK and a leading researcher in 
    ...
    # particularly the King's Quest series
    ...
    # Developed in 1974 what is now known as Diffie-Hellman key exchange
    # (Diffie and Hellman first published the scheme in 1976).
    ...
    # The Wright brothers, Orville and Wilbur - credited with inventing and building the world's
    # first successful airplane and making the first controlled, powered and sustained heavier-than-air human flight
    # https://en.wikipedia.org/wiki/Wright_brothers
    "wright",

    # Chien-Shiung Wu - Chinese-American experimental physicist who made significant contributions
    # to nuclear physics.
    ...
    # Ada Yonath - an Israeli crystallographer, the first woman from the Middle East to
    # win a Nobel prize in the sciences.
    # https://en.wikipedia.org/wiki/Ada_Yonath
    "yonath",

    # Nikolay Yegorovich Zhukovsky (Russian: Никола́й Его́рович Жуко́вский, January 17 1847 – March 17, 1921)
    # was a Russian scientist, mathematician and engineer, and a founding father of modern aero- and hydrodynamics.
    # Whereas contemporary scientists scoffed at the idea of human flight,
    # Zhukovsky was the first to undertake the study of airflow. He is often called the Father of Russian Aviation.
