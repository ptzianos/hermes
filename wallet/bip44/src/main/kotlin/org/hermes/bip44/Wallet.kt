...
class Wallet(seed: ByteArray, keyRegistry: KeyRegistry = InMemoryKeyRegistry()) {
    ...
    class Context(val coinType: String, val account: Int, val change: Int = 0, private val wallet: BIP32Wallet) {
    ...
    val masterWallet: BIP32Wallet = ExtendedWallet(seed, keyRegistry = keyRegistry)
